...
{
    using BaseType = XmlNamedNodeMap;
...
public:
    ...
    public:
        ...
        ASPOSECPP_SHARED_API XmlAttribute::Ptr get_Current() const override;
    ...
    XmlNode::Ptr GetNamedItem(const String& local_name, const String& namespace_uri) override;
...
protected:
    ...
    /// Destructor.
    ASPOSECPP_SHARED_API ~XmlAttributeCollection() override;
