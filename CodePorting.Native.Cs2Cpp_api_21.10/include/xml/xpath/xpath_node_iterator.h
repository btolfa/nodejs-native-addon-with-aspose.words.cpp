                          ...
                          public System::Collections::Generic::IEnumerator<XPathNavigator::Ptr>
{
    ...
    typedef System::Collections::Generic::IEnumerable<XPathNavigator::Ptr> BaseType;
    typedef System::Collections::Generic::IEnumerator<XPathNavigator::Ptr> BaseType1;
...
public:
    ...
    ASPOSECPP_SHARED_API XPathNavigator::Ptr get_Current() const override;
...
protected:
    ...
    MEMBER_FUNCTION_MAKE_OBJECT(XPathNodeIterator, CODEPORTING_ARGS(const XPathDocument::Ptr& doc, const XPathNavigator::Ptr& parent_navigator, xmlXPathObject* xpath_obj), CODEPORTING_ARGS(doc, parent_navigator, xpath_obj));
    /// Destructor.
    ASPOSECPP_SHARED_API ~XPathNodeIterator() override;
