/// @file xml/detail/xml_native_error.h
#pragma once
...
enum class Code
{
    ...
    Domain domain = Domain::NONE; // What part of the library raised this er
    Code code = Code::ERR_OK; // The error code, e.g. an xmlParserError
    String message; // human-readable informative error messag
    Level level = Level::NONE; // how consequent is the error
    String file; // the filename
    int32_t line = 0; // extra string information
    String str1; // extra string information
    String str2; // extra string information
    String str3; // extra string information
    int32_t int1 = 0; // extra number information
    int32_t int2 = 0; // error column # or 0 if N/A 

    /// Constructs XmlNativeError from libxml2 xmlError object
    /// @param error the libxml2 native error object pointer
    ...
    XmlNativeError& operator=(const XmlNativeError& other) = default;

    /// Move assign operator 
    XmlNativeError& operator=(XmlNativeError&& other) noexcept = default;

    /// Checks if the error value is valid, i.e. non-zero.
    /// false if level == 0, true otherwise.
    ...
    /// @param error libxml2 native error object
